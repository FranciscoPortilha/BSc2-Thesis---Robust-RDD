...
def plotComparison(sample, name1, name2="", name3="", cutoff=0):
    ...
    plt.plot(
        ...
        color="b",
        linewidth=0.7,
        label=name1 + " (ate: " + str(round(tau1, 2)) + ")",
    )
    if name2 != "":
        plt.plot(
            x_below,
            params2_below.iloc[0] + params2_below.iloc[1] * x_below,
            color="g",
            linewidth=0.7,
        )
        plt.plot(
            x_above,
            params2_above.iloc[0] + params2_above.iloc[1] * x_above,
            color="g",
            linewidth=0.7,
            label=name2 + " (ate: " + str(round(tau2, 2)) + ")",
        )
    if name3 != "":
        plt.plot(
            x_below,
            params3_below.iloc[0] + params3_below.iloc[1] * x_below,
            color="purple",
            linewidth=0.7,
        )
        plt.plot(
            x_above,
            params3_above.iloc[0] + params3_above.iloc[1] * x_above,
            color="purple",
            linewidth=0.7,
            label=name3 + " (ate: " + str(round(tau3, 2)) + ")",
        )
